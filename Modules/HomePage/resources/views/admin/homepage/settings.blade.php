                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-4">
                                    ...
                                    @php
                                        $sections = [
                                            'show_events' => 'Eventos',
                                            'show_publications' => 'Transparência / Publicações',
                                ...
                                <div class="space-y-4">
                                    ...
                                    @php
                                        $titles = [
                                            ...
                                            'publications_title' => 'Título de Publicações',
                                    ...
                                    @endforeach
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Texto introdutório (Publicações)</label>
                                        <textarea name="publications_intro" rows="2" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 text-sm">{{ old('publications_intro', $homepageSettings['publications_intro'] ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab-content-estatisticas" class="tab-content hidden">
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Igrejas locais (manual; 0 = usar cadastro ativo)</label>
                                    <input type="number" name="stats_churches" min="0" value="{{ old('stats_churches', $homepageSettings['stats_churches'] ?? 0) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500">
                                </div>
                                <div>
