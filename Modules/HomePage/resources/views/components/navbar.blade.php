...
<nav class="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex md:items-center md:space-x-1">
                ...
                <a href="{{ route('public.transparency.index') }}"
                    class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-800 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200">Transparência</a>
    ...
    <div id="mobile-menu"
        ...
        <div class="px-4 pt-4 pb-6 space-y-2">
            ...
            <a href="{{ route('public.transparency.index') }}"
                class="block px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 rounded-xl text-base font-medium transition-colors">Transparência</a>
