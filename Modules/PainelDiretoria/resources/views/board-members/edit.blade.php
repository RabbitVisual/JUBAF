...
@section('content')
    <div class="mx-auto max-w-7xl space-y-8 pb-16 font-sans animate-fade-in">
        @include('paineldiretoria::partials.board-members-subnav', ['active' => 'edit'])
        ...
        <header
            ...
            <div class="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                <div class="min-w-0 flex-1">
                    <p class="text-xs font-semibold uppercase tracking-widest text-indigo-700 dark:text-indigo-400">Edição · 4
                        etapas</p>
        ...
        <form action="{{ route($routePrefix . '.update', $boardMember) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
