...
class EventController extends Controller
{
    ...
    /**
     * Página de confirmação após inscrição gratuita (painel do membro).
     */
    public function registrationConfirmed(EventRegistration $registration): View
    {
        if ($registration->user_id !== auth()->id()) {
            abort(403, __('events::messages.unauthorized_access') ?? 'Acesso não autorizado.');
        }
