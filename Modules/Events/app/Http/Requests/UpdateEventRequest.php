...
class UpdateEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Classification
            'institutional_track' => 'nullable|string|max:64|in:conjubaf,congresso_lideres,start_jubaf,encontro_setores,jubaf_na_estrada,outro',
            'event_type_id'     => 'nullable|exists:event_types,id',
            'ministry_id'       => 'nullable|integer',
            'setlist_id'        => 'nullable|integer',
