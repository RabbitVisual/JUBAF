...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.events.registrations.export-badges', $event) }}?{{ http_build_query(request()->query()) }}"
                    target="_blank"
    ...
    <!-- Export Options -->
    <div class="flex flex-wrap items-center gap-3">
        <a href="{{ route('admin.events.registrations.export-excel', $event) }}?{{ http_build_query(request()->query()) }}"
            class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
            <x-icon name="file-excel" style="duotone" class="w-4 h-4 mr-2 text-green-600" />
            {{ __('events::messages.export_excel') }}
        </a>
        <a href="{{ route('admin.events.registrations.export-pdf', $event) }}?{{ http_build_query(request()->query()) }}"
            target="_blank"
            class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <form method="GET" action="{{ route('admin.events.registrations.index', $event) }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex gap-2 md:col-span-2">
                ...
                @if (request()->has('status') || request()->has('age_group'))
                    <a href="{{ route('admin.events.registrations.index', $event) }}" class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.events.registrations.show', [$event, $registration]) }}"
