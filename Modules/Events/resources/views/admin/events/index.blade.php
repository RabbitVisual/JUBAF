...
@section('title', __('events::messages.events_jubaf_admin') . ' — Administração')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('events::messages.events_jubaf_admin') }}</h1>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800 overflow-hidden group hover:border-amber-500/50 transition-all duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-3 gap-2 mt-6">
                            ...
                            <a href="{{ route('admin.events.registrations.index', $event) }}" class="flex items-center justify-center px-3 py-2 bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/30 font-medium text-sm transition-colors">
                                Inscrições
                            </a>
