...
use Modules\Secretaria\App\Policies\ConvocationPolicy;
...
class SecretariaServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Secretaria';

    protected string $nameLower = 'secretaria';
    ...
    public function boot(): void
    {
        ...
        Gate::policy(Minute::class, MinutePolicy::class);
        Gate::policy(Convocation::class, ConvocationPolicy::class);
        Gate::policy(SecretariaDocument::class, SecretariaDocumentPolicy::class);
    }
