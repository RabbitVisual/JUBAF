...
@section('content')
    <div class="mx-auto max-w-2xl space-y-6">
        ...
        <form method="post" action="{{ route('memberpanel.governance.diretoria.minutes.update', $minute) }}" enctype="multipart/form-data"
            ...
            <div class="flex flex-col-reverse gap-3 border-t border-gray-100 pt-6 dark:border-slate-800 sm:flex-row sm:justify-end">
                ...
                <button type="submit" class="inline-flex justify-center rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700">Atualizar</button>
            </div>
        </form>
    </div>
@endsection
