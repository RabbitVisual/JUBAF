...
@section('content')
    <div class="mx-auto max-w-2xl space-y-6">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Apenas PDF, até 15&nbsp;MB.</p>
        </div>

        <form method="post" action="{{ route('admin.diretoria.minutes.store') }}" enctype="multipart/form-data"
            ...
            <div class="flex flex-col-reverse gap-3 border-t border-gray-100 pt-6 dark:border-slate-800 sm:flex-row sm:justify-end">
                ...
                <button type="submit" class="inline-flex justify-center rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">Guardar</button>
            </div>
        </form>
    </div>
@endsection
