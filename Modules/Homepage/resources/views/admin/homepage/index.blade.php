...
@section('content')
    <div class="space-y-6 md:space-y-8">
        ...
        <div
            ...
            <div>
                <h1
                    class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white flex items-center gap-3 mb-2 font-poppins">
                    <div
                        class="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <nav aria-label="breadcrumb" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    <a href="{{ route('admin.dashboard') }}"
                        class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Admin</a>
            ...
            <div class="flex flex-wrap items-center gap-2">
                @if (auth()->user()?->hasRole('super-admin'))
                    <a href="{{ route('admin.config.index') }}#branding"
                        class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-blue-700 bg-blue-50 dark:bg-blue-900/30 dark:text-blue-300 border border-blue-200 dark:border-blue-800 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all">
                        <x-icon name="image" class="w-5 h-5" style="duotone" />
                        <span>Logos e nome do site</span>
                    </a>
                    <a href="{{ route('admin.config.index') }}#bible_homepage"
                        class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-slate-700 bg-slate-50 dark:bg-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-600 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition-all">
                        <x-icon name="gear" class="w-5 h-5" style="duotone" />
                        <span>Config. avançadas (Bíblia / integrações)</span>
                    </a>
                @endif
                <a href="{{ route('homepage') }}" target="_blank"
                    class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-xl hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all shadow-md hover:shadow-lg">
        ...
        <div class="flex overflow-x-auto pb-2 gap-2 hide-scrollbar">
            <button onclick="showTab('sections')" id="tab-sections"
                class="tab-button flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap bg-white dark:bg-slate-800 border-2 border-blue-600 text-blue-700 dark:text-blue-400 shadow-sm">
                <x-icon name="layer-group" class="w-4 h-4" style="duotone" />
                Seções
            </button>
            <button onclick="showTab('carousel')" id="tab-carousel"
                class="tab-button flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap bg-white dark:bg-slate-800 border-2 border-transparent text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700">
                <x-icon name="images" class="w-4 h-4" style="duotone" />
                Carousel
            </button>
            <button onclick="showTab('content')" id="tab-content"
                class="tab-button flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap bg-white dark:bg-slate-800 border-2 border-transparent text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700">
            ...
            <button onclick="showTab('navbar')" id="tab-navbar"
                class="tab-button flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap bg-white dark:bg-slate-800 border-2 border-transparent text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700">
                <x-icon name="bars" class="w-4 h-4" style="duotone" />
                Menu Navbar
            </button>
            <button onclick="showTab('bible')" id="tab-bible"
                class="tab-button flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 whitespace-nowrap bg-white dark:bg-slate-800 border-2 border-transparent text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-slate-700">
                <x-icon name="book-bible" class="w-4 h-4" style="duotone" />
                Bíblia
            </button>
        ...
        <div id="tab-content-sections" class="tab-content">
            <div
                class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                <div
                    class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Gerenciar Seções da
                            Homepage</h3>
        ...
        <div id="tab-content-carousel" class="tab-content hidden">
            <div
                class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden mb-6">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Gerenciar Carousel
                            </h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Gerencie os slides do carousel da
                                homepage</p>
                        </div>
                        <a href="{{ route('admin.carousel.index') }}"
                            class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-indigo-800 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <a href="{{ route('admin.carousel.create') }}"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-indigo-800 transition-all duration-300 shadow-md hover:shadow-lg">
        ...
        <div id="tab-content-content" class="tab-content hidden">
            <form action="{{ route('admin.homepage.update') }}" method="POST" class="space-y-6">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Hero (início)</h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Página pública — Diretoria
                        </h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Rádio 3:16 e Devocionais
                        </h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Secção de atividades</h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Sobre</h3>
                    </div>
                ...
                <div class="flex justify-end gap-3">
                    <button type="submit"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-blue-900 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5">
        ...
        <div id="tab-content-contact" class="tab-content hidden">
            <form action="{{ route('admin.homepage.update') }}" method="POST" class="space-y-6">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Informações de Contato
                        </h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div
                        class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Página /contato &
                                newsletter</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Textos públicos, formulário e
                                inscrições regionais</p>
                        </div>
                        <div class="flex flex-wrap gap-2">
                            @if (Route::has('admin.homepage.contacts.index'))
                            ...
                            @endif
                            @if (Route::has('admin.homepage.newsletter.index'))
                    ...
                    @php
                        $navbarLinks = [
                            ...
                            'navbar_sobre' => [
                                'name' => 'Sobre',
                                'icon' => 'circle-info',
                                'description' => 'Link para a página Sobre (/sobre)',
                            ],
                            'navbar_diretoria' => [
                                'name' => 'Diretoria',
                                'icon' => 'users',
        ...
        <div id="tab-content-bible" class="tab-content hidden">
            <form action="{{ route('admin.homepage.update') }}" method="POST" class="space-y-6">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Bíblia na homepage</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Versículo do dia (estável por dia civil) e
                            ...
                            <strong>Configurações do sistema</strong> (grupo Bíblia — homepage).</p>
                    </div>
        ...
        <div id="tab-content-footer" class="tab-content hidden">
            <form action="{{ route('admin.homepage.update') }}" method="POST" class="space-y-6">
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Configurações do Footer
                        </h3>
                ...
                <div
                    class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-gray-900/50">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white font-poppins">Créditos técnicos no
                            rodapé</h3>
            ...
            <script>
                function showTab(tabName) {
                    ...
                    document.querySelectorAll('.tab-button').forEach(button => {
                        button.classList.remove('border-blue-600', 'text-blue-700', 'dark:text-blue-400', 'bg-white',
                            'dark:bg-slate-800');
                    ...
                    activeTab.classList.add('border-blue-600', 'text-blue-700', 'dark:text-blue-400', 'bg-white',
                        'dark:bg-slate-800');
                }
