    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 md:pb-6 border-b border-gray-200 dark:border-slate-700">
        <div>
            ...
            <p class="max-w-2xl text-sm leading-relaxed text-gray-600 dark:text-gray-400 mb-2">
                Isto é o “vocabulário” do sistema: cada permissão é uma <strong class="font-medium text-gray-800 dark:text-gray-200">ação concreta</strong>.
                Ninguém recebe permissões diretamente — elas entram nas <strong class="font-medium text-gray-800 dark:text-gray-200">funções</strong>, e os utilizadores recebem as funções.
            </p>
