...
<div class="mx-auto max-w-7xl space-y-8 pb-16 font-sans animate-fade-in">
    ...
    @include('blog::paineldiretoria.partials.page-hero', [
        'kicker' => 'Taxonomia',
        'title' => 'Editar tag',
        'lead' => 'Alterar o nome atualiza o vínculo nos posts; verifique o slug se o endereço público da tag importa.',
        'iconName' => 'tags',
        'crumbs' => [
            ...
            ['label' => Str::limit($tag->name, 28), 'url' => null],
        ],
        'actions' => view('blog::paineldiretoria.partials.hero-actions-tag-edit', ['tag' => $tag])->render(),
    ])

<!-- Form -->
<div class="max-w-2xl">
    <form action="{{ blog_admin_route('tags.update', $tag->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
