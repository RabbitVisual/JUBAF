...
<div class="mx-auto max-w-7xl space-y-8 pb-16 font-sans animate-fade-in">
    @include('blog::paineldiretoria.partials.subnav', ['active' => 'create'])

    @include('blog::paineldiretoria.partials.page-hero', [
        'kicker' => 'Novo conteúdo',
        'title' => 'Criar post',
        'lead' => 'Defina título, categoria, mídia e privacidade. Você pode salvar como rascunho e publicar depois.',
        'iconName' => 'pen-to-square',
        'crumbs' => [
            ['label' => 'Diretoria', 'url' => route('diretoria.dashboard')],
            ['label' => 'Blog', 'url' => blog_admin_route('index')],
            ['label' => 'Novo post', 'url' => null],
        ],
        'actions' => view('blog::paineldiretoria.partials.hero-actions-post-form')->render(),
    ])

<!-- Form -->
<form action="{{ blog_admin_route('store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6">
                ...
                <div class="blog-editor-wrapper">
                    <div id="blog-content-editor" class="h-96" data-upload-url="{{ blog_admin_route('upload-image') }}"></div>
        ...
        <div class="space-y-6">
            ...
            @include('blog::partials.post-tags-field', ['tags' => $tags])
        </div>
    </div>
</form>
</div>
