...
<div class="mx-auto max-w-7xl space-y-8 pb-16 font-sans animate-fade-in">
    ...
    @include('blog::paineldiretoria.partials.page-hero', [
        ...
        'lead' => 'Nome, slug, cor e ordem definem como a categoria aparece no blog e nos filtros administrativos.',
        ...
        'actions' => view('blog::paineldiretoria.partials.hero-actions-category-form', [
            'backUrl' => blog_admin_route('categories.index'),
        ])->render(),
    ])
