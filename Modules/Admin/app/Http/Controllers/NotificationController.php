...
class NotificationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('notifications::admin.notifications.create', compact('users', 'roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (empty($validated['target_users']) && empty($validated['target_roles'])) {
     ...
     */
    private function distributeNotification(SystemNotification $notification): void
    {
