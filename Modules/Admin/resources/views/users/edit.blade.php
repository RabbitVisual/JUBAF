        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 md:p-8">
            <div class="flex items-start gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Papel no sistema e vínculo com a igreja federada (ASBAF).</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="church_id" id="church_id" class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            @foreach($churches as $c)
                                <option value="{{ $c->id }}" {{ (string) old('church_id', $user->church_id) === (string) $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                            @endforeach
                        </select>
                    </div>
                @endif
                <div class="md:col-span-2 flex items-center gap-3">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $user->is_active ? '1' : '0') == '1' ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="3" placeholder="Notas visíveis apenas para administradores"
                              class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('notes', $user->notes) }}</textarea>
                </div>
            </div>
        </div>
