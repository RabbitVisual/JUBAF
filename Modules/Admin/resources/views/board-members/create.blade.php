...
<div class="space-y-6 md:space-y-8 pb-12 max-w-5xl">
    ...
    <form action="{{ route('admin.board-members.store') }}" method="post" enctype="multipart/form-data" class="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 p-6 md:p-8 space-y-8">
        @csrf
        ...
        <div class="flex flex-wrap gap-3 pt-4 border-t border-gray-100 dark:border-slate-700">
            <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-indigo-600 text-white font-semibold hover:bg-indigo-700">Guardar</button>
