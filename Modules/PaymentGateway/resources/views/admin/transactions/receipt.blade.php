...
<body>
    ...
    <div class="receipt">
        ...
        <table>
            <tr><td>Tipo</td><td>{{ match($payment->payment_type ?? '') { 'donation' => 'Doação', 'event_registration' => 'Inscrição em evento', 'offering' => 'Oferta', 'campaign' => 'Campanha', default => $payment->payment_type ?? '—' } }}</td></tr>
