...
class DonationPaymentService
{
    ...
    /**
     * Resolve payable_type, payable_id e description a partir de payment_type e campaign_id.
     *
    ...
    public function resolvePayableAndDescription(
        ...
        if ($paymentType === 'campaign' && $campaignId) {
     ...
     *
     * @param  array{amount: float, payment_gateway_id: int, payment_type: string, campaign_id?: int, description?: string, payer_name?: string, payer_email?: string, payer_document?: string, payment_method?: string}  $validated
