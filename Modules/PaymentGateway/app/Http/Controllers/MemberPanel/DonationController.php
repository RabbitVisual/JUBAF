...
class DonationController extends Controller
{
    ...
    public function index()
    {
        $payments = Payment::where('user_id', Auth::id())
            ->whereIn('payment_type', ['donation', 'offering', 'campaign', 'tithe'])
            ->with(['gateway'])
    ...
    {
        $type = $request->get('type', 'donation'); // donation, offering, campaign
        ...
        return view('paymentgateway::memberpanel.donations.create', compact('gateways', 'type', 'campaign', 'campaigns'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'payment_type' => 'required|in:donation,offering,campaign',
