    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Preencha os dados institucionais e lideranças associadas.</p>
            </div>
        ...
        <form action="{{ route('memberpanel.churches.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug') }}" required
                            class="block w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white pb-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
