...
@section('content')
    <div class="flex min-h-[60vh] items-center justify-center py-8">
        <div class="w-full max-w-md">
            <div class="overflow-hidden rounded-3xl border border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900 shadow-xl">
                <div class="bg-gradient-to-br from-stone-800 to-stone-950 px-8 py-10 text-center relative overflow-hidden">
                    ...
                    <div class="relative">
                        <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 border border-white/10">
                            <x-icon name="book-bible" class="w-8 h-8 text-teal-300" />
                        </div>
                        <h1 class="text-xl font-bold text-white tracking-tight">Bíblia digital</h1>
                        <p class="mt-1 text-[11px] font-semibold uppercase tracking-widest text-stone-400">Conteúdo por configurar</p>
                    </div>
                </div>
                <div class="px-8 py-10 text-center">
                    ...
                    <h2 class="text-lg font-bold text-stone-900 dark:text-white">Ainda não há traduções importadas</h2>
                    ...
                    <div class="mt-8 flex flex-col gap-3">
                        <a href="{{ route('jovens.dashboard') }}"
                           class="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-teal-600 hover:bg-teal-700 text-white px-4 py-3.5 text-sm font-semibold shadow-md shadow-teal-600/20 transition-colors">
                        ...
                        @if(Route::has('jovens.bible.plans.index'))
                            <a href="{{ route('jovens.bible.plans.index') }}"
                               class="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-800/50 px-4 py-3 text-sm font-semibold text-stone-700 dark:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors">
                                <x-icon name="calendar-days" class="w-4 h-4 text-teal-600" />
