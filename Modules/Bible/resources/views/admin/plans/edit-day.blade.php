...
@section('content')
<x-bible::admin.layout :showNav="false" title="Studio de edição — {{ $day->title }}" subtitle="Plano: {{ $plan->title }}">
<div class="min-h-screen bg-linear-to-b from-amber-50/40 to-stone-100/50 dark:from-stone-950 dark:to-stone-900 pb-20 rounded-2xl border border-amber-200/40 dark:border-amber-900/30 overflow-hidden">
