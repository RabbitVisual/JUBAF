...
@section('content')
    <x-bible::admin.layout
        ...
        subtitle="Selecione livros e confirme para distribuir o cronograma em {{ $plan->duration_days }} dias.">
        <x-slot name="actions">
            <a href="{{ bible_admin_route('plans.show', $plan->id) }}" class="inline-flex items-center px-4 py-2.5 border border-amber-200/80 dark:border-amber-900/50 rounded-xl text-sm font-semibold text-stone-800 dark:text-stone-100 bg-white dark:bg-stone-800 hover:bg-amber-50 dark:hover:bg-stone-700 transition-colors">
                Cancelar
            </a>
        </x-slot>
