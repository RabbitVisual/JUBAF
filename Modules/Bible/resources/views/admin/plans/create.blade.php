...
@section('content')
    <x-bible::admin.layout
        ...
        subtitle="Defina tipo, duração e identidade visual do plano de leitura.">
        <x-slot name="actions">
            <a href="{{ bible_admin_route('plans.index') }}" class="inline-flex items-center px-4 py-2.5 border border-amber-200/80 dark:border-amber-900/50 rounded-xl text-sm font-semibold text-stone-800 dark:text-stone-100 bg-white dark:bg-stone-800 hover:bg-amber-50 dark:hover:bg-stone-700 transition-colors">
                Voltar
            </a>
        </x-slot>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="plan_complexity" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Complexidade sugerida</label>
                                <select id="plan_complexity" name="complexity" class="w-full md:w-1/2 rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm">
                            ...
                            <div>
                                <label for="template_key" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Chave de modelo interno (opcional)</label>
                                <input type="text" id="template_key" name="template_key" maxlength="64" placeholder="ex.: cbav2026, advento"
