...
@section('content')
    <x-bible::admin.layout
        ...
        subtitle="Membros inscritos no plano oficial e engajamento na leitura.">
        <x-slot name="actions">
            <a href="{{ bible_admin_route('plans.index') }}"
                class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-stone-800 dark:text-stone-100 bg-white dark:bg-stone-800 border border-amber-200/80 dark:border-amber-900/50 rounded-xl hover:bg-amber-50 dark:hover:bg-stone-700 transition-all">
        ...
        @if($churchPlans->isEmpty())
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-amber-200/70 dark:border-amber-900/45 p-8 text-center shadow-sm">
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-amber-200/70 dark:border-amber-900/45 overflow-hidden">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white px-6 py-4 border-b border-amber-200/50 dark:border-amber-900/40 flex items-center gap-2 font-serif bg-amber-50/40 dark:bg-amber-950/20">
