...
@section('breadcrumbs')
    ...
    <span class="text-slate-400">/</span>
    <span class="text-slate-600 dark:text-slate-300">Leitura</span>
@endsection
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between py-4 gap-4">
                    ...
                    <div class="flex items-center gap-3">
                         <div class="p-2 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg">
                             <x-icon name="book-bible" class="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                         </div>
                         <div>
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        <a href="{{ route('lideres.bible.search') }}"
                        ...
                        <a href="{{ route('lideres.bible.favorites') }}"
                            class="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 text-xs font-bold uppercase tracking-widest text-gray-600 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-100 hover:text-red-500 dark:bg-slate-900 dark:text-slate-400 dark:border-slate-800 dark:hover:bg-slate-800 dark:hover:text-red-400 transition-all">
                            <x-icon name="heart" class="w-4 h-4 mr-2" />
                            Favoritos
                        </a>
                       <a href="{{ route('lideres.bible.interlinear') }}"
                            class="flex-1 sm:flex-none inline-flex items-center justify-center px-4 py-2 text-xs font-bold uppercase tracking-widest text-white bg-emerald-600 border border-transparent rounded-xl hover:bg-emerald-700 shadow-lg shadow-emerald-500/20 transition-all">
            ...
            <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm" data-tour="bible-version">
                <div class="flex flex-col md:flex-row md:items-center gap-6">
                    ...
                    <div class="w-full md:w-72">
                        <div class="relative">
                            <select id="version-select" onchange="window.location.href = {{ json_encode(rtrim(route('lideres.bible.read'), '/')) }} + '/' + encodeURIComponent(this.value)"
                                class="w-full appearance-none pl-4 pr-10 py-3 bg-gray-50 dark:bg-slate-800 border-2 border-transparent focus:border-emerald-500 dark:focus:border-emerald-500 rounded-xl text-sm font-bold text-gray-900 dark:text-white outline-none transition-all cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700">
