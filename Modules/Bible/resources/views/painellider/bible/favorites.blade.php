    ...
    <div class="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors pb-12">
        ...
        <div class="sticky top-0 z-30 bg-white/90 dark:bg-slate-950/90 backdrop-blur-xl border-b border-gray-200 dark:border-slate-800 transition-colors">
            <div class="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <a href="{{ route('lideres.bible.read', \Modules\Bible\App\Models\BibleVersion::first()->abbreviation ?? 'NVI') }}"
            ...
            <div class="space-y-4">
                @forelse($favorites as $verse)
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-6 shadow-sm hover:shadow-lg hover:border-red-200 dark:hover:border-red-900/50 transition-all duration-300 group relative">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <a href="{{ route('lideres.bible.chapter', ['version' => $version->abbreviation, 'book' => $book->book_number, 'chapter' => $chapter->chapter_number]) }}#verse-{{ $verse->verse_number }}"
                               class="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-white font-bold text-xs hover:bg-emerald-50 hover:text-emerald-600 dark:hover:bg-emerald-900/30 dark:hover:text-emerald-400 transition-colors">
                ...
                @empty
                    <div class="text-center py-24">
                        ...
                        <a href="{{ route('lideres.bible.index') }}"
                            class="inline-flex items-center px-6 py-3 text-sm font-bold text-white bg-emerald-600 rounded-xl hover:bg-emerald-700 shadow-lg shadow-emerald-500/20 transition-all">
                            Começar Leitura
                        </a>
                    </div>
                @endforelse
