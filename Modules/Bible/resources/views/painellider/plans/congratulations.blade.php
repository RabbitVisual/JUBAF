    ...
    <div class="max-w-xl w-full mx-4">
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden text-center relative p-8 md:p-12">
            ...
            <div class="relative z-10">
                ...
                <div class="space-y-4">
                    @if($nextDay)
                        <a href="{{ route('lideres.bible.reader', ['subscriptionId' => $subscription->id, 'day' => $nextDay]) }}" class="w-full inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-purple-600 rounded-xl hover:bg-purple-700 hover:shadow-lg hover:-translate-y-1 transform group">
                            Próxima Leitura
                    ...
                    <a href="{{ route('lideres.bible.plans.index') }}" class="w-full inline-flex items-center justify-center px-8 py-4 text-base font-bold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
