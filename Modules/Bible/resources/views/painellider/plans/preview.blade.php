...
@section('breadcrumbs')
    ...
    <span class="text-slate-400">/</span>
    <a href="{{ route('lideres.bible.plans.catalog') }}" class="text-emerald-600 dark:text-emerald-400 hover:underline">Catálogo</a>
    <span class="text-slate-400">/</span>
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-6">
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden p-8 text-center space-y-6">
                    ...
                    <form action="{{ route('lideres.bible.plans.subscribe', $plan->id) }}" method="POST">
                        @csrf
