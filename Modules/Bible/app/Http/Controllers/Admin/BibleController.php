...
use Modules\Bible\App\Http\Controllers\Admin\Concerns\ResolvesBibleAdminContext;
use Modules\Bible\App\Services\BibleApiService;

class BibleController extends Controller
{
    use ResolvesBibleAdminContext;
    ...
    public function index()
    {
        ...
        return view($this->bibleView('bible.index'), compact('versions'));
    }

    public function create()
    {
        return redirect()->to($this->bibleRoute('import'));
    }
    ...
    public function show($bible)
    {
        ...
        return view($this->bibleView('bible.show'), compact('version', 'books', 'oldTestament', 'newTestament'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to($this->bibleRoute('index'))
    ...
    public function edit($bible)
    {
        ...
        return view($this->bibleView('bible.edit'), compact('version'));
    }
    ...
    public function update(Request $request, $bible)
    {
        ...
        $this->bibleApi->bumpContentRevision();
    ...
    public function importForm()
    {
        ...
        return view($this->bibleView('bible.import'), compact('availableFiles', 'versionsInfo'));
    }
    ...
    public function viewBook($version, $book)
    {
        ...
        return view($this->bibleView('bible.book'), [
    ...
    public function viewChapter($version, $book, $chapter)
    {
        ...
        return view($this->bibleView('bible.chapter'), [
            'version' => $versionModel,
            'book' => $bookModel,
    ...
    public function chapterAudioIndex($bible)
    {
        ...
        return view($this->bibleView('bible.chapter-audio'), compact('version', 'audios'));
    }
    ...
    public function chapterAudioStore(Request $request, $bible)
    {
        ...
        if (empty($rows)) {
            return redirect()->to($this->bibleRoute('chapter-audio.index', $version))
