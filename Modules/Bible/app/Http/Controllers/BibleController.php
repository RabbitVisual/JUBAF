...
class BibleController extends Controller
{
    ...
    public function import()
    {
        ...
        return view('bible::admin.bible.import', compact('availableFiles'));
    }
    ...
    public function storeImport(Request $request)
    {
        ...
        return redirect()->to(bible_admin_route('index'))->with('success', 'Versão importada com sucesso (Simulação).');
    }
}
