...
class ProfileController extends Controller
{
    ...
    {
        $user = Auth::user();
        $user->load(['roles', 'permissions', 'church', 'assignedChurches', 'profilePhotos']);

        return view('painellider::profile.index', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('lideres.profile.index')
