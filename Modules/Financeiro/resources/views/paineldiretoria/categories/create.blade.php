...
<div class="mx-auto max-w-3xl space-y-8 pb-10">
    ...
    <div>
        ...
        <h1 class="mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl">Nova categoria</h1>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Defina nome, grupo e tipo. O código é opcional mas recomendado para relatórios longos.</p>
    </div>

    <form action="{{ route('diretoria.financeiro.categories.store') }}" method="post" class="space-y-6">
        @csrf
