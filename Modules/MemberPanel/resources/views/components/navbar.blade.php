                        ...
                        @forelse($recentNotifications as $notification)
                            @php
                                ...
                                $byCategory = [
                                    ...
                                    'achievement' => ['icon' => 'trophy', 'bg' => 'bg-yellow-100 dark:bg-yellow-900/30', 'iconColor' => 'text-yellow-600 dark:text-yellow-400'],
                                    'default' => ['icon' => 'bell', 'bg' => 'bg-gray-100 dark:bg-gray-700/50', 'iconColor' => 'text-gray-600 dark:text-gray-400'],
                                ];
                                $typeKey = $notif->notification_type ?? 'generic';
                                $iconConfig = $byCategory[$typeKey] ?? $byCategory['default'];
                            @endphp
