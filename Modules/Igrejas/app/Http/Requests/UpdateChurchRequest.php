...
class UpdateChurchRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $church instanceof Church && $this->user()?->can('update', $church);
    }
    ...
    {
        $church = $this->route('church');
        $id = $church instanceof Church ? $church->id : 0;
        ...
        return [
            ...
            'cnpj' => [
                ...
                Rule::unique('igrejas_churches', 'cnpj')->ignore($id),
                new CnpjValid,
            ],
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique(Church::class, 'slug')->ignore($id)],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $v): void {
            ...
            if ($pid && $church instanceof Church && (int) $pid === (int) $church->id) {
                $v->errors()->add('parent_church_id', 'A igreja não pode ser mãe de si mesma.');
            }
            if ($pid) {
