    ...
    <div id="erp-chat-root"
        ...
        <aside class="w-full shrink-0 border-b border-slate-200 bg-slate-50/80 dark:border-slate-700 dark:bg-slate-900/80 lg:w-80 lg:border-b-0 lg:border-r">
            <div class="border-b border-slate-200 px-4 py-3 dark:border-slate-700">
                ...
                <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Contacte a diretoria / suporte institucional.</p>
            </div>
            <div id="erp-chat-new" class="border-b border-slate-200 p-3 dark:border-slate-700">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" id="erp-open-btn" class="shrink-0 rounded-lg bg-emerald-600 px-3 py-2 text-xs font-semibold text-white hover:bg-emerald-700">Abrir</button>
                </div>
            </div>
            <div id="erp-chat-conversation-list" class="max-h-72 overflow-y-auto divide-y divide-slate-100 dark:divide-slate-800 lg:max-h-[calc(100vh-14rem)]"></div>
        </aside>
        <section class="flex min-h-[320px] flex-1 flex-col">
            ...
            <form id="erp-chat-form" class="border-t border-slate-200 p-3 dark:border-slate-700">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="submit" id="erp-chat-submit" disabled class="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50">Enviar</button>
                </div>
            </form>
        </section>
    </div>
