...
return [
    ...
    */
    'stubs' => [
        'enabled' => true,
        'path' => base_path('stubs/vertex-solutions'),
        'files' => [
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'vertex-solutions'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Vertex Solutions LTDA'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'dev@vertexsolutions.com.br'),
        ],
