...
| Não inclui: /admin (routes/admin.php) nem rotas do painel do membro (routes/member.php).
...
// =====================================================================
// Transparência — atas e comunicados (Governance)
// =====================================================================
Route::prefix('transparencia')->middleware('throttle:120,1')->name('public.transparency.')->group(function () {
    Route::get('/', [\Modules\Governance\Http\Controllers\PublicTransparencyController::class, 'index'])->name('index');
    Route::get('/atas/{minute:slug}', [\Modules\Governance\Http\Controllers\PublicTransparencyController::class, 'showMinute'])->name('minute');
    Route::get('/comunicados/{communication:slug}', [\Modules\Governance\Http\Controllers\PublicTransparencyController::class, 'showCommunication'])->name('communication');
});
