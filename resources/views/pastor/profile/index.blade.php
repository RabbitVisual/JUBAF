...
<div class="space-y-6 md:space-y-10 animate-fade-in pb-12">
    ...
    <form method="POST" action="{{ route('lideres.profile.update') }}" enctype="multipart/form-data" id="profileForm">
        ...
        <x-profile.panel-quick-links context="pastor" accent="emerald" class="mb-8" />
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/80 md:p-8 mb-8">
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">ID #{{ $user->id }} · conta de pastor</p>
            @if($user->church)
