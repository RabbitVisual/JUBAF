...
<div class="text-center">
    ...
    <div class="mt-16 pt-8 border-t border-white/5 space-y-4">
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <a href="{{ route('public.transparency.index') }}" class="text-slate-400 hover:text-purple-400 transition-colors flex items-center gap-2 font-bold text-xs uppercase tracking-wider">
                <x-icon name="landmark" style="duotone" />
                Transparência
            </a>
